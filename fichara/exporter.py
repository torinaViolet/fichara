...
if __name__ == '__main__':
    ...
    # 导出Markdown
    print("\n3. 导出为Markdown...")
    CharacterCardExporter.save_markdown(card, "output.md")

    # 从JSON创建PNG
    print("\n4. 从JSON创建PNG...")
    CharacterCardExporter.from_json_to_png(
        "output.json",
        r"C:\Users\Violet\Downloads\测试.png",
        "output_from_json.png"
    )

    # 更换图片
    print("\n5. 更换角色卡图片...")
    # 首先创建一个新的默认图片
    new_img = CharacterCardExporter.create_default_image("new_image.png")
    # 然后更换图片
    CharacterCardExporter.change_image(
        r"C:\Users\Violet\Downloads\测试.png",
        new_img,
        "output_new_image.png"
    )

    # 从零创建PNG
    print("\n6. 从零创建PNG角色卡...")
    CharacterCardExporter.create_png_from_scratch(
        card,
        new_img,
        "output_from_scratch.png"
    )
    ...
    print("Markdown预览:")
    print("=" * 60 + "\n")
    markdown_preview = CharacterCardExporter.to_markdown(card)
    # 只显示前500个字符
